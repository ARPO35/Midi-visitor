  ...
  return (
    <div className="relative mb-3" ref={popoverRef}>
      <div className="flex items-center justify-between group">
        <span className="text-[10px] text-zinc-500 uppercase tracking-wider group-hover:text-zinc-300 transition-colors">
          {label}
        </span>
        <button
          onClick={() => {
            const currentMode = value.startsWith('linear-gradient')
              ? 'gradient'
        ...
        >
          <div className="w-6 h-4 rounded-[2px] shadow-inner border border-white/10 overflow-hidden">
            <div
        ...
        <div className="absolute right-0 top-full mt-2 z-[100] w-64 p-4 rounded-xl border border-zinc-700 bg-zinc-950 shadow-2xl backdrop-blur-3xl">
                    ...
                    <input
                      ...
                      style={
                        chan === 'h'
                          ...
                          : chan === 's'
                            ? { background: `linear-gradient(to right, #808080, hsl(${hsla.h}, 100%, 50%))` }
          ...
          {mode === 'image' && (
            <div className="space-y-4 text-center">
              ...
              <div className="text-[10px] text-zinc-600">Supports JPG, PNG, GIF, WEBP</div>
            </div>
          )}
        </div>
      )}
